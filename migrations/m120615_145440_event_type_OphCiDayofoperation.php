	...
	public function up() {
		...
		$this->createTable('et_ophcidayofoperation_details', array(
			...
			'cjd_checklist' => 'tinyint(1) unsigned NOT NULL', // CJD checklist completed and filed in the notes
				...
				'created_date' => 'datetime NOT NULL DEFAULT \'1901-01-01 00:00:00\'',
				'PRIMARY KEY (`id`)',
				'KEY `Details_lmui_fk` (`last_modified_user_id`)',
				'KEY `Details_cui_fk` (`created_user_id`)',
				'KEY `Details_ev_fk` (`event_id`)',
								'KEY `et_ophcidayofoperation_details_medical_history_changed_fk` (`medical_history_changed_id`)',
								'CONSTRAINT `Details_lmui_fk` FOREIGN KEY (`last_modified_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `Details_cui_fk` FOREIGN KEY (`created_user_id`) REFERENCES `user` (`id`)',
				'CONSTRAINT `Details_ev_fk` FOREIGN KEY (`event_id`) REFERENCES `event` (`id`)',
