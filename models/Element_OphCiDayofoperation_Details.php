...
/**
 * This is the model class for table "et_ophcidayofoperation_details".
 *
...
class Element_OphCiDayofoperation_Details extends BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophcidayofoperation_details';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'usermodified' => array(self::BELONGS_TO, 'User', 'last_modified_user_id'),
						'medical_history_changed' => array(self::BELONGS_TO, 'EtOphcidayofoperationDetailsMedicalHistoryChanged', 'medical_history_changed_id'),
					);
	}
...
$criteria->compare('medical_history_changed_id', $this->medical_history_changed_id);
$criteria->compare('inr_level', $this->inr_level);
$criteria->compare('preop_checklist', $this->preop_checklist);
$criteria->compare('cjd_checklist', $this->cjd_checklist);
